      ...
      {showSuccess && (
        <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, background: 'rgba(0,0,0,0.5)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 9999, animation: 'fadeIn 0.2s ease-out' }}>
          <div style={{ background: 'white', padding: '3rem', borderRadius: '24px', textAlign: 'center', maxWidth: '400px', width: '90%', boxShadow: '0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04)' }}>
            ...
            <h3 style={{ fontSize: '1.5rem', marginBottom: '1rem', color: 'var(--text-main)', fontWeight: '800' }}>Request Sent!</h3>
            <p style={{ color: 'var(--text-muted)', marginBottom: '2rem', lineHeight: '1.6' }}>We have successfully received your details. Our team will contact you shortly.</p>
      ...
      <main className="animate-fade-in" style={{ background: 'var(--bg-secondary)', paddingBottom: '6rem' }}>
        <div className="container" style={{ paddingTop: '4rem' }}>
          ...
          <section className="rd-intro" style={{ maxWidth: '1200px' }}>
            ...
            <p className="hero-subtitle" style={{ margin: '0 auto 3rem', color: 'var(--text-muted)', fontSize: '1.2rem', lineHeight: '1.8', maxWidth: '1100px', padding: '0 1rem' }}>
          ...
          <section className="collab-section">
            <div className="collab-content">
              ...
              <p style={{ color: 'var(--text-muted)', lineHeight: '1.8', fontSize: '1.1rem' }}>
                Reach out to us at <a href="mailto:tanmayrandomuse@gmail.com" className="collab-email">tanmayrandomuse@gmail.com</a> or fill out the following form to explore collaboration opportunities.
              </p>
            </div>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div style={{ display: 'flex', gap: '1.5rem' }}>
                  <div style={{ flex: 1 }}>
                    ...
                    <input type="text" name="firstName" className="form-input" style={{ padding: '0.6rem 1rem' }} placeholder="John" required />
                  </div>
                  <div style={{ flex: 1 }}>
                    <label className="form-label" style={{ fontSize: '0.9rem', marginBottom: '0.25rem' }}>Last Name</label>
                    <input type="text" name="lastName" className="form-input" style={{ padding: '0.6rem 1rem' }} placeholder="Doe" required />
                  </div>
                </div>
                ...
                <div style={{ display: 'flex', gap: '1.5rem', marginTop: '1.5rem' }}>
                  <div style={{ flex: 1 }}>
                    ...
                    <input type="email" name="email" className="form-input" style={{ padding: '0.6rem 1rem' }} placeholder="john@example.com" required />
                  </div>
                  <div style={{ flex: 1 }}>
                    <label className="form-label" style={{ fontSize: '0.9rem', marginBottom: '0.25rem' }}>Contact No.</label>
                    <input type="tel" name="phone" className="form-input" style={{ padding: '0.6rem 1rem' }} placeholder="+91 98765 43210" required />
                  </div>
                </div>

                <div style={{ marginTop: '1.5rem' }}>
                  <label className="form-label" style={{ fontSize: '0.9rem', marginBottom: '0.25rem' }}>Organization Name</label>
                  <input type="text" name="organization" className="form-input" style={{ padding: '0.6rem 1rem' }} placeholder="University or Company" required />
                </div>

                <div style={{ marginTop: '1.5rem' }}>
                  <label className="form-label" style={{ fontSize: '0.9rem', marginBottom: '0.25rem' }}>Message</label>
                  <textarea name="message" className="form-textarea" style={{ minHeight: '80px', padding: '0.6rem 1rem' }} placeholder="How would you like to collaborate?" required></textarea>
                </div>

                <button type="submit" disabled={isSubmitting} className="btn btn-primary" style={{ padding: '0.875rem', fontSize: '1.1rem', width: '100%', maxWidth: '300px', marginTop: '1.5rem', opacity: isSubmitting ? 0.7 : 1 }}>
                  {isSubmitting ? 'Submitting...' : <span style={{ display: 'flex', alignItems: 'center' }}>Submit Request <Send size={18} style={{ marginLeft: '8px' }} /></span>}
                </button>
              </form>
            </div>
          </section>
